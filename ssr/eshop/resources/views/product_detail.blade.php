                ...
                <div class="d-flex flex-column gap-5 p-2 col-md-5">
                    <div class="d-flex flex-column h-100 justify-content-center gap-6">
                        <div class="d-flex flex-column">
                            ...
                            <h2 class="text-4xl mb-2 font-semibold">{{ $product->name }}</h2>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="row row-cols-md-3 row-cols-2 g-2 ">
                            @foreach ($product->gallery as $image)
                                <div class="col">
                                    <img src="{{ $image }}" alt="gallery image" class="w-100" />
                                </div>
                            @endforeach
                        </div>
                    </div>
                    <div class="d-flex flex-column">
                        <div class="d-flex flex-column">
                            <div class="d-flex flex-column">
                                ...
                                <p>
                                    <strong>Kategória produktu:</strong>{{ $product->category }}
                                </p>
                                <p><strong>Výrobca:</strong> {{ $product->manufacturer }}</p>
